...
class UserDeletionTestCase(WgerTestCase):
    ...
    def test_delete_user_does_not_recreate_statistics(self):
        ...
        WorkoutSession.objects.create(
            user=user, datetime_start=datetime.datetime(2024, 1, 1, tzinfo=datetime.timezone.utc)
        )
...
class LoadDataSignalGuardTestCase(WgerTestCase):
    ...
    def test_raw_workout_session_save_skips_statistics(self):
        ...
        session = WorkoutSession.objects.create(
            user=self.user,
            datetime_start=datetime.datetime(2024, 1, 1, tzinfo=datetime.timezone.utc),
        )
