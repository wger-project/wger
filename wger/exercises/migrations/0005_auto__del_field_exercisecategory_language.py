...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExerciseCategory.language'
        db.delete_column(u'exercises_exercisecategory', 'language_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ExerciseCategory.language'
        raise RuntimeError("Cannot reverse this migration. 'ExerciseCategory.language' and its values cannot be restored.")
