...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseImage.status'
        db.add_column(u'exercises_exerciseimage', 'status',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExerciseImage.status'
        db.delete_column(u'exercises_exerciseimage', 'status')
