...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exercise.language'
        db.add_column(u'exercises_exercise', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['exercises.Language']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exercise.language'
        db.delete_column(u'exercises_exercise', 'language_id')
