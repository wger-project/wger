...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExerciseLanguageMapper'
        db.create_table(u'exercises_exerciselanguagemapper', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'exercises', ['ExerciseLanguageMapper'])

        # Adding field 'Exercise.language_mapper'
        db.add_column(u'exercises_exercise', 'language_mapper',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exercises.ExerciseLanguageMapper'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ExerciseLanguageMapper'
        db.delete_table(u'exercises_exerciselanguagemapper')

        # Deleting field 'Exercise.language_mapper'
        db.delete_column(u'exercises_exercise', 'language_mapper_id')
