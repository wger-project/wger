...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExerciseImage.license_author'
        db.add_column(u'exercises_exerciseimage', 'license_author',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'exercises_exerciseimage', 'license')

        # Deleting field 'ExerciseImage.license_author'
        db.delete_column(u'exercises_exerciseimage', 'license_author')
