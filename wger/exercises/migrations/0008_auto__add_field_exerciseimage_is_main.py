...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExerciseImage.is_main'
        db.add_column(u'exercises_exerciseimage', 'is_main',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExerciseImage.is_main'
        db.delete_column(u'exercises_exerciseimage', 'is_main')
