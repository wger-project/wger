...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MealItem.amount_gramm'
        db.alter_column('nutrition_mealitem', 'amount_gramm', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'MealItem.amount_gramm'
        db.alter_column('nutrition_mealitem', 'amount_gramm', self.gf('django.db.models.fields.IntegerField')(max_length=4))
    ...
    models = {
        ...
        'nutrition.mealitem': {
            ...
            'amount_gramm': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredient': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['nutrition.Ingredient']"}),
