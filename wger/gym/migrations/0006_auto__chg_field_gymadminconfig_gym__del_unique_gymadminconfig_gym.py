...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'GymAdminConfig', fields ['gym']
        db.delete_unique(u'gym_gymadminconfig', ['gym_id'])


        # Changing field 'GymAdminConfig.gym'
        db.alter_column(u'gym_gymadminconfig', 'gym_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gym.Gym']))

    def backwards(self, orm):

        # Changing field 'GymAdminConfig.gym'
        db.alter_column(u'gym_gymadminconfig', 'gym_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gym.Gym'], unique=True))
        # Adding unique constraint on 'GymAdminConfig', fields ['gym']
        db.create_unique(u'gym_gymadminconfig', ['gym_id'])
