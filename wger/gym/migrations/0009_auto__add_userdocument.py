...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserDocument'
        db.create_table(u'gym_userdocument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='userdocument_user', to=orm['auth.User'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='userdocument_member', to=orm['auth.User'])),
            ...
            ('original_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
        ))
        db.send_create_signal(u'gym', ['UserDocument'])


    def backwards(self, orm):
        # Deleting model 'UserDocument'
        db.delete_table(u'gym_userdocument')
    ...
    models = {
        ...
        u'gym.userdocument': {
            'Meta': {'ordering': "['-timestamp_created']", 'object_name': 'UserDocument'},
            'document': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'userdocument_member'", 'to': u"orm['auth.User']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '60', 'blank': 'True'}),
            'original_name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'timestamp_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'timestamp_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'userdocument_user'", 'to': u"orm['auth.User']"})
        }
    }
