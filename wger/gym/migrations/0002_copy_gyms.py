...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for gym_core in orm['core.Gym'].objects.all():
            gym = orm.Gym()
            gym.id = gym_core.id
            gym.name = gym_core.name
            gym.phone = gym_core.phone
            gym.email = gym_core.email,
            gym.owner = gym_core.owner,
            gym.zip_code = gym_core.zip_code
            gym.city = gym_core.city
            gym.street = gym_core.street
            gym.save()
