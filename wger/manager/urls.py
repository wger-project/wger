...
urlpatterns = patterns('',
    ...
    url(r'^workout/calendar/(?P<year>\d{4})-(?P<month>\d{1,2})$',
        log.calendar,
        name='workout-calendar'),
    url(r'^workout/(?P<pk>\d+)/ical/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$',
        ical.export,
        name='workout-ical'),
    url(r'^workout/(?P<pk>\d+)/ical$',
        ...
        name='workout-ical'),
    # PDF
    url(r'^workout/(?P<id>\d+)/pdf/log/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$',
        pdf.workout_log,
        name='workout-pdf-log'),
    url(r'^workout/(?P<id>\d+)/pdf/log$',
         pdf.workout_log,
         name='workout-pdf-log'),
    url(r'^workout/(?P<id>\d+)/pdf/table/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$',
        pdf.workout_view,
    ...
    url(r'^workout/schedule/(?P<pk>\d+)/view$',
        schedule.view,
        name='schedule-view'),
    url(r'^workout/schedule/(?P<pk>\d+)/start$',
        schedule.start,
        name='schedule-start'),
    ...
    url(r'^workout/schedule/(?P<pk>\d+)/ical/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})$',
