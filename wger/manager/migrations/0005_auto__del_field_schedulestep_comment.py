...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ScheduleStep.comment'
        db.delete_column(u'manager_schedulestep', 'comment')


    def backwards(self, orm):
        # Adding field 'ScheduleStep.comment'
        db.add_column(u'manager_schedulestep', 'comment',
