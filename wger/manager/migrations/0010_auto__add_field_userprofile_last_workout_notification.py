...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.last_workout_notification'
        db.add_column(u'manager_userprofile', 'last_workout_notification',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.last_workout_notification'
        db.delete_column(u'manager_userprofile', 'last_workout_notification')
