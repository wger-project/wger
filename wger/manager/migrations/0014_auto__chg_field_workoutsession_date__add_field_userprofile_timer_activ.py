...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkoutSession.date'
        db.alter_column(u'manager_workoutsession', 'date', self.gf('wger.utils.fields.Html5DateField')())
        # Adding field 'UserProfile.timer_active'
        db.add_column(u'manager_userprofile', 'timer_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.timer_pause'
        db.add_column(u'manager_userprofile', 'timer_pause',
                      self.gf('wger.utils.fields.Html5IntegerField')(default=90),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'WorkoutSession.date'
        db.alter_column(u'manager_workoutsession', 'date', self.gf('wger.utils.fields.Html5DateField')(auto_now_add=True))
        # Deleting field 'UserProfile.timer_active'
        db.delete_column(u'manager_userprofile', 'timer_active')

        # Deleting field 'UserProfile.timer_pause'
        db.delete_column(u'manager_userprofile', 'timer_pause')
