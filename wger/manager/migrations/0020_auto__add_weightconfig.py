...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeightConfig'
        db.create_table(u'manager_weightconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schedule_step', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manager.ScheduleStep'])),
            ('setting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manager.Setting'])),
            ('start', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2)),
            ('increment', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
        ))
        db.send_create_signal(u'manager', ['WeightConfig'])


    def backwards(self, orm):
        # Deleting model 'WeightConfig'
        db.delete_table(u'manager_weightconfig')
    ...
    models = {
        ...
        u'exercises.exercise': {
            ...
            'language_mapper': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['exercises.ExerciseLanguageMapper']", 'null': 'True', 'blank': 'True'}),
        ...
        u'exercises.exerciselanguagemapper': {
            'Meta': {'object_name': 'ExerciseLanguageMapper'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'exercises.muscle': {
        ...
        u'manager.schedulestep': {
            ...
            'duration': ('django.db.models.fields.IntegerField', [], {'default': '4'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'manager.weightconfig': {
            'Meta': {'object_name': 'WeightConfig'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'increment': ('django.db.models.fields.DecimalField', [], {'max_digits': '4', 'decimal_places': '2'}),
            'schedule_step': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['manager.ScheduleStep']"}),
            'setting': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['manager.Setting']"}),
            'start': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '2'})
        },
        u'manager.workout': {
