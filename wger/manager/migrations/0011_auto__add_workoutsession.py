...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkoutSession'
        db.create_table(u'manager_workoutsession', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('workout', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manager.Workout'])),
            ('date', self.gf('wger.utils.fields.Html5DateField')(auto_now_add=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('impression', self.gf('django.db.models.fields.CharField')(default='2', max_length=2)),
            ('time_start', self.gf('django.db.models.fields.TimeField')()),
            ('time_end', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal(u'manager', ['WorkoutSession'])


    def backwards(self, orm):
        # Deleting model 'WorkoutSession'
        db.delete_table(u'manager_workoutsession')
    ...
    models = {
        ...
        u'manager.workoutsession': {
            'Meta': {'ordering': "['date']", 'object_name': 'WorkoutSession'},
