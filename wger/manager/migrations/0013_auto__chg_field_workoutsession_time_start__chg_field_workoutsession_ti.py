...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkoutSession.time_start'
        db.alter_column(u'manager_workoutsession', 'time_start', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'WorkoutSession.time_end'
        db.alter_column(u'manager_workoutsession', 'time_end', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WorkoutSession.time_start'
        raise RuntimeError("Cannot reverse this migration. 'WorkoutSession.time_start' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WorkoutSession.time_start'
        db.alter_column(u'manager_workoutsession', 'time_start', self.gf('django.db.models.fields.TimeField')())

        # User chose to not deal with backwards NULL issues for 'WorkoutSession.time_end'
        raise RuntimeError("Cannot reverse this migration. 'WorkoutSession.time_end' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'WorkoutSession.time_end'
        db.alter_column(u'manager_workoutsession', 'time_end', self.gf('django.db.models.fields.TimeField')())
    ...
    models = {
        ...
        u'manager.workoutsession': {
            ...
            'date': ('wger.utils.fields.Html5DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
