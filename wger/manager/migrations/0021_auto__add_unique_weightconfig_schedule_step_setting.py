...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WeightConfig', fields ['schedule_step', 'setting']
        db.create_unique(u'manager_weightconfig', ['schedule_step_id', 'setting_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WeightConfig', fields ['schedule_step', 'setting']
        db.delete_unique(u'manager_weightconfig', ['schedule_step_id', 'setting_id'])
    ...
    models = {
        ...
        u'manager.weightconfig': {
            'Meta': {'unique_together': "(('schedule_step', 'setting'),)", 'object_name': 'WeightConfig'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
