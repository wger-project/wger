...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.notification_language'
        db.add_column(u'manager_userprofile', 'notification_language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['exercises.Language']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.notification_language'
        db.delete_column(u'manager_userprofile', 'notification_language_id')
