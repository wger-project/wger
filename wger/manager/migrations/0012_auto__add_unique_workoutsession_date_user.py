...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WorkoutSession', fields ['date', 'user']
        db.create_unique(u'manager_workoutsession', ['date', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WorkoutSession', fields ['date', 'user']
        db.delete_unique(u'manager_workoutsession', ['date', 'user_id'])
