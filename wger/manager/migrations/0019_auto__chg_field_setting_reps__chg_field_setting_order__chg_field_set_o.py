...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'manager_set', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))
        ...
        db.alter_column(u'manager_schedulestep', 'duration', self.gf('django.db.models.fields.IntegerField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ScheduleStep.duration'
        db.alter_column(u'manager_schedulestep', 'duration', self.gf('wger.utils.fields.Html5IntegerField')())
