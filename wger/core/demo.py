...
def create_demo_entries(user):
    ...
    setting = Setting(set=day_set, exercise_base=exercise.exercise_base, reps=8, order=1)
    setting.save()
    ...
    setting_list.append(Setting(set=day_set, exercise_base=exercise.exercise_base, reps=8, order=1))
