...
7000 entries, but can be somewhat overwhelming and make the search difficult.'''),
    ...
    ro_access = models.BooleanField(verbose_name=_('Allow read-only access'),
                                    help_text=_('Allow anonymous users to access your workouts and '
                                                'logs in a read-only mode. You can  then share the '
