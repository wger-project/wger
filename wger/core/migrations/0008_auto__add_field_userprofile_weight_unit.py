...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_userprofile', 'weight_unit',
                      self.gf('django.db.models.fields.CharField')(default='kg', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.weight_unit'
        db.delete_column(u'core_userprofile', 'weight_unit')
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'weight_unit': ('django.db.models.fields.CharField', [], {'default': "'kg'", 'max_length': '2'}),
