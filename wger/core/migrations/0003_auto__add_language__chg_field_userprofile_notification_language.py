...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        '''
        db.rename_table('exercises_language', 'core_language')

        if not db.dry_run:
            # For permissions to work properly after migrating
            orm['contenttypes.contenttype'].objects.filter(app_label='exercises', model='language').update(app_label='core')

        # Changing field 'UserProfile.notification_language'
        db.alter_column(u'core_userprofile', 'notification_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Language']))
    ...
    def backwards(self, orm):
        ...
        db.rename_table('core_language', 'exercises_language')

        if not db.dry_run:
            # For permissions to work properly after migrating
            orm['contenttypes.contenttype'].objects.filter(app_label='core', model='language').update(app_label='exercises')


        # Changing field 'UserProfile.notification_language'
        db.alter_column(u'core_userprofile', 'notification_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['exercises.Language']))
