...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.gym'
        db.alter_column(u'core_userprofile', 'gym_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gym.Gym'], null=True))

    def backwards(self, orm):
        # Adding model 'Gym'
        db.create_table(u'core_gym', (
        ...
        db.send_create_signal(u'core', ['Gym'])


        # Changing field 'UserProfile.gym'
        db.alter_column(u'core_userprofile', 'gym_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Gym'], null=True))
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'gym': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['gym.Gym']", 'null': 'True', 'blank': 'True'}),
