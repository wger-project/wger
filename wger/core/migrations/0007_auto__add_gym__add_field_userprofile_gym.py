...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.gym'
        db.add_column(u'core_userprofile', 'gym',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Gym'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.gym'
        db.delete_column(u'core_userprofile', 'gym_id')
