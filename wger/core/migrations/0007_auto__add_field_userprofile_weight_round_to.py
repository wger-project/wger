...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.routines_round_to'
        db.add_column(u'core_userprofile', 'routines_round_to',
                      self.gf('django.db.models.fields.DecimalField')(default=1.25, max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.routines_round_to'
        db.delete_column(u'core_userprofile', 'routines_round_to')
    ...
    models = {
        ...
        u'core.userprofile': {
            ...
            'routines_round_to': ('django.db.models.fields.DecimalField', [], {'default': '1.25', 'max_digits': '4', 'decimal_places': '2'}),
