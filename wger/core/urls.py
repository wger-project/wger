...
patterns_language = [
    path('list', languages.LanguageListView.as_view(), name='overview'),
    path('<int:pk>/view', languages.LanguageDetailView.as_view(), name='view'),
    path('<int:pk>/delete',
         languages.LanguageDeleteView.as_view(),
         name='delete'),
    path('<int:pk>/edit', languages.LanguageEditView.as_view(), name='edit'),
    path('add', languages.LanguageCreateView.as_view(), name='add'),
]
...
patterns_user = [
    ...
    path('<int:pk>/activate', user.UserActivateView.as_view(),
         name='activate'),
...
patterns_license = [
    path('license/list', license.LicenseListView.as_view(), name='list'),
    path('license/add', license.LicenseAddView.as_view(), name='add'),
...
patterns_repetition_units = [
    path('list', repetition_units.ListView.as_view(), name='list'),
    path('add', repetition_units.AddView.as_view(), name='add'),
    path('<int:pk>/edit', repetition_units.UpdateView.as_view(), name='edit'),
    path('<int:pk>/delete',
...
patterns_weight_units = [
    path('list', weight_units.ListView.as_view(), name='list'),
    path('add', weight_units.AddView.as_view(), name='add'),
    path('<int:pk>)/edit', weight_units.UpdateView.as_view(), name='edit'),
    path('<int:pk>/delete', weight_units.DeleteView.as_view(), name='delete'),
]
...
urlpatterns = [
    ...
    path('contact',
         ...
         name='contact'),
    path('feedback', misc.FeedbackClass.as_view(), name='feedback'),
    path('language/',
         include((patterns_language, 'language'), namespace="language")),
    path('user/', include((patterns_user, 'user'), namespace="user")),
    path('license/', include((patterns_license, 'license'),
                             namespace="license")),
    path(
        'repetition-unit/',
        include((patterns_repetition_units, 'repetition-unit'),
                namespace="repetition-unit")),
    path(
        'weight-unit/',
        include((patterns_weight_units, 'weight-unit'),
