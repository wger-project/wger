...
patterns_user = [
    ...
    path('preferences/disconnect-keycloak', user.disconnect_keycloak, name='disconnect-keycloak'),
    ...
    path(
        '<int:pk>/disconnect-keycloak',
        user.UserDisconnectKeycloakView.as_view(),
        name='disconnect-keycloak',
    ),
