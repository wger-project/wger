...
The frontend that is built with react uses its own translation files. See
the README.md file in the locale folder in the react repo for more information.
